...
typedef enum command_list_s{
  SYS=10,APP,DEVIN=0,DEVOUT=1,CPU,MEM
} command_t;

typedef enum string_args_list_s{
  START=10, END, PROCESS, ALLOCATE, ACCESS, ETHERNET=0, HDD=1, KEYBOARD=2, MONITOR=3, SERIAL=4, SOUND_SIGNAL=5, USB=6, VIDEO_SIGNAL=7
